              ...
              <div className={styles.contactInfo}>
                ...
                <div className={styles.socialLinks}>
                  ...
                  <div className={styles.socialIcons}>
                    <a 
                      href="https://www.linkedin.com/in/wareesha-malik-32a353358/"
                      target="_blank"
                    ...
                    <a 
                      href="https://www.instagram.com/wareesha._.here/"
                      target="_blank"
                      rel="noopener noreferrer" 
                      className={styles.socialIcon}
                    >
                    ...
                    <a 
                      href="https://www.facebook.com/profile.php?id=61571753242506&mibextid=ZbWKwL"
                      target="_blank"
                      rel="noopener noreferrer" 
                      className={styles.socialIcon}
                    >
